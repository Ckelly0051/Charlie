...
h3{color:#0f3460;border-bottom:1px solid #ddd;padding-bottom:4px;margin-top:24px}
...
.stat-card-value{font-size:22px;font-weight:bold;color:#0f3460}
.season-summary{display:flex;flex-wrap:wrap;gap:18px;background:#0f3460;color:#fff;padding:14px;border-radius:6px;justify-content:space-around}
