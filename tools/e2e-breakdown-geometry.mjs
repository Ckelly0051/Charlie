...
ok(state.type.eyebrow.font>=12&&state.type.title.font>=19&&state.type.unit.font>=12.5&&state.type.action.font>=12.5&&state.type.action.height>=30&&state.type.chip.font>=12.5&&state.type.chip.height>=30&&!state.type.title.clipped,'1440 charting keeps canonical consumer-size type and controls without clipping',JSON.stringify(state.type));
