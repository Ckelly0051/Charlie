...
export const P0_CAPABILITIES = [
  ...
  { id:'breakdown.context-isolation', surface:'breakdown', evidence:'data', harness:'e2e-s5c-preflight.mjs', assertion:'Context edits change only perspective and direction, never opponent or game metadata' },
