...
export const P0_CAPABILITIES = [
  ...
  { id:'breakdown.all-fields', surface:'breakdown', evidence:'data', harness:'e2e-native-tagging.mjs', assertion:'Every standard offense/defense/situation field has a native owner' },
  ...
  { id:'breakdown.special-teams', surface:'breakdown', evidence:'data', harness:'e2e-native-tagging.mjs', assertion:'Native try editor preserves compound events and official return ruling' },
  { id:'breakdown.penalties', surface:'breakdown', evidence:'data', harness:'e2e-native-tagging.mjs', assertion:'Native penalty form writes enforcement and the confirmed resulting snap' },
  { id:'breakdown.save-next', surface:'breakdown', evidence:'data', harness:'e2e-native-tagging.mjs', assertion:'Save & Next advances chronologically without collapse' },
  ...
  { id:'breakdown.game-context', surface:'breakdown', evidence:'data', harness:'e2e-native-tagging.mjs', assertion:'Native context follows game switch without inheritance' },
  ...
  { id:'breakdown.play-diagram', surface:'breakdown', evidence:'data', harness:'e2e-native-tagging.mjs', assertion:'Templates, diagram, OCR, detection, commit, drive, and customization remain reachable' },
  { id:'breakdown.scoreboard-ocr', surface:'breakdown', evidence:'behavior', harness:'e2e-native-tagging.mjs', assertion:'Diagram and OCR commands reach canonical owners exactly once' },
  { id:'breakdown.templates', surface:'breakdown', evidence:'data', harness:'e2e-native-tagging.mjs', assertion:'Templates, diagram, OCR, detection, commit, drive, and customization remain reachable' },
