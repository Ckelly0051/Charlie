...
export const P0_CAPABILITIES = [
  ...
  { id:'breakdown.game-context', surface:'breakdown', evidence:'data', harness:'e2e-s5c-preflight.mjs', assertion:'Game open restores its perspective, direction, and scout presentation together' },
  ...
  { id:'breakdown.play-diagram', surface:'breakdown', evidence:'data', harness:'e2e-s5c-preflight.mjs', assertion:'A saved play diagram remains byte-stable and produces its Call Sheet thumbnail' },
  ...
  { id:'breakdown.templates', surface:'breakdown', evidence:'data', harness:'e2e-s5c-preflight.mjs', assertion:'Same-as-Last and template save/apply remain live canonical actions' },
