...
JS_FILES="
  ...
  js/charts.js js/multi-angle.js js/stats-engine.js js/analytics-registry.js js/workspace-context.js js/study-query.js js/cross-game-cutup.js js/study-screen.js js/workspace-shell.js js/history-manager.js
