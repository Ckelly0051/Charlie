...
JS_FILES="
  js/beta-config.js js/tag-projection.js js/special-teams.js js/penalty-model.js js/football-rules.js js/video-controller.js js/canvas-overlay.js js/play-tagger.js
  js/roster-manager.js js/play-filter.js js/notes-manager.js js/sql-catalog.js js/catalog-persistence.js js/snapshot-envelope.js js/storage-backend.js
...
cat css/workspace-shell.css >> "$OUTPUT"
